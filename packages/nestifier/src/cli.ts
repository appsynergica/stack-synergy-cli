...
let gqlsifierConfig: INestifierConfig;
...
if(options.project)
{
    ...
    if(!gqlsifierConfig)
    {
        gqlsifierConfig = {
            ...
            // Nestifier Options : Base Class Options
            globalOptions: {
            ...
            // Nestifier Options : IDecorator Options
