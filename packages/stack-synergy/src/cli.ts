...
let gqlsifierConfig: IStackSynergyConfig;
...
if(options.project)
{
    ...
    if(!gqlsifierConfig)
    {
        gqlsifierConfig = {
            ...
            // StackSynergy Options : Base Class Options
            globalOptions: {
            ...
            // StackSynergy Options : IDecorator Options
