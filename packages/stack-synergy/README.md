...
> A Command Line Interface that combines all the other tools above with a console GUI enquirer prompt for a more seamless programming experience. 

## Installation

```shell
npm i @urbanshona/stack-synergy
```

## Usage

```shell
stack-synergy -s [Input] -o [Output] -q [Quote]
...
e.g stack-synergy -s server/entities -o browser/entities -q true
